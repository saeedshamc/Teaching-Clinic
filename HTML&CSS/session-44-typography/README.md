# جلسه 44: تایپوگرافی واکنش‌گرا با clamp() — ۱.۵ ساعت

## 🎯 اهداف یادگیری

1. fluid typography با clamp() بنویسید
2. min, preferred, max در clamp
3. viewport units برای font-size
4. line-height و measure (ch)
5. typography scale بسازید
...
clamp(MIN, PREFERRED, MAX) — بین MIN و MAX

---

## ۳. vw + rem

ترکیب vw و rem برای fluid بودن

---

## ۴. line-height

تیتر: 1.2 — بدنه: 1.6–1.8
...
| فایل | توضیح |
|------|--------|
| [01_clamp_heading.html](./examples/01_clamp_heading.html) | مثال 1 |
| [02_fluid_body.html](./examples/02_fluid_body.html) | مثال 2 |
| [03_type_scale.html](./examples/03_type_scale.html) | مثال 3 |
| [04_responsive_prose.html](./examples/04_responsive_prose.html) | مثال 4 |
...
**جلسه قبل:** [43 — پروژه: پست وبلاگ](../session-43-blog-post/) | **بعد:** [45 — بهترین شیوه‌های CSS](../session-45-best-practices/)
