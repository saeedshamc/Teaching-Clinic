# جلسه 47: دیباگ با DevTools — ۱.۵ ساعت

## 🎯 اهداف یادگیری

1. Elements panel: inspect و edit live
2. Styles panel: cascade و specificity
3. Console برای خطاهای JS/CSS
4. Network و Performance overview
5. عیب‌یابی layout با Grid/Flex overlay
...
F12 یا Ctrl+Shift+I — Elements، Console، Network

---

## ۲. Inspect

کلیک راست → Inspect — HTML/CSS live edit

---

## ۳. Styles

خط خورده = override — specificity
...
| فایل | توضیح |
|------|--------|
| [01_intentional_typo.html](./examples/01_intentional_typo.html) | مثال 1 |
| [02_specificity_bug.html](./examples/02_specificity_bug.html) | مثال 2 |
| [03_broken_css_path.html](./examples/03_broken_css_path.html) | مثال 3 |
| [04_layout_debug.html](./examples/04_layout_debug.html) | مثال 4 |
...
**جلسه قبل:** [46 — مبانی Sass/SCSS](../session-46-sass/) | **بعد:** [48 — بهینه‌سازی CSS](../session-48-performance/)
...
107. CSS خارجی را با `<link rel="stylesheet" href="...">` وصل کنید.
